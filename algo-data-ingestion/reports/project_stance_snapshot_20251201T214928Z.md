...
Generated at: 2025-12-01T21:49:28.208036Z
...
## Symbols
- ETH/USDT: policy=primary shadow=False notional=80.0 thresholds={'entry_threshold': 0.5, 'exit_threshold': 0.48, 'exit_prob_drop': 0.1, 'min_hold_bars': 3, 'stop_loss_pct': None, 'take_profit_pct': 0.001}
- BTC/USDT: policy=conservative shadow=False notional=50.0 thresholds={'entry_threshold': 0.52, 'exit_threshold': 0.5, 'exit_prob_drop': 0.1, 'min_hold_bars': 3, 'stop_loss_pct': None, 'take_profit_pct': 0.001}
- SOL/USDT: policy=conservative shadow=False notional=40.0 thresholds={'entry_threshold': 0.52, 'exit_threshold': 0.5, 'exit_prob_drop': 0.1, 'min_hold_bars': 3, 'stop_loss_pct': None, 'take_profit_pct': 0.001}
...
algo-data-ingestion/Dockerfile                     |   1 +
 ...
 algo-data-ingestion/app/trading/decision.py        | 117 +++++++++++-
 algo-data-ingestion/app/trading/service.py         | 209 ++++++++++++++++++++-
 ...
 13 files changed, 502 insertions(+), 47 deletions(-)