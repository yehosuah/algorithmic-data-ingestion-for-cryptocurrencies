# Docker Live 48H All Forensics (Executed Exits)
...
| SOL/USDT |       28 |   0.464286 | 0.138461  | -0.109947  |       1.25935  |        1.09143  | -0.117387  |  -0.208157 |  0.150793  |

## Portfolio loss drivers (by exit_reason_primary)
| exit_reason_primary   |   count |   loss_sum_abs |   loss_share |
|:----------------------|--------:|---------------:|-------------:|
| stop_loss             |      16 |       2.25763  |     0.766181 |
| time_limit            |      14 |       0.688974 |     0.233819 |
...
|   trades |      pnl |   win_rate |   avg_win |   avg_loss |   payoff_ratio |   profit_factor |   max_drawdown_pnl |    p95_loss |    p99_loss |   cvar_95 |   max_loss |   max_win |
|---------:|---------:|-----------:|----------:|-----------:|---------------:|----------------:|-------------------:|------------:|------------:|----------:|-----------:|----------:|
|       28 | 0.150793 |   0.464286 |  0.138461 |  -0.109947 |        1.25935 |         1.09143 |           0.613896 | -0.00925198 | -0.00648241 | -0.117387 |  -0.208157 |  0.289235 |

**Loss drivers**
| exit_reason_primary   |   count |   loss_sum_abs |   loss_share |
|:----------------------|--------:|---------------:|-------------:|
| stop_loss             |       7 |       1.19752  |     0.726119 |
| time_limit            |       8 |       0.451685 |     0.273881 |

**Upside starvation**
|   regret_fraction |   mean_regret_gap |   short_hold_fraction_lt_5m |   take_profit_trades | take_profit_avg_exit_return   | take_profit_avg_mfe   | take_profit_regret_fraction   |
|------------------:|------------------:|----------------------------:|---------------------:|:------------------------------|:----------------------|:------------------------------|
|          0.642857 |        0.00325455 |                           0 |                    0 |                               |                       |                               |
