...
Generated at: 2025-12-01T21:37:00.013110Z
...
## Symbols
- ETH/USDT: policy=primary shadow=False notional=80.0 thresholds={'entry_threshold': 0.5, 'exit_threshold': 0.48, 'exit_prob_drop': 0.1, 'min_hold_bars': 3, 'stop_loss_pct': None, 'take_profit_pct': 0.003}
- BTC/USDT: policy=conservative shadow=False notional=50.0 thresholds={'entry_threshold': 0.52, 'exit_threshold': 0.5, 'exit_prob_drop': 0.1, 'min_hold_bars': 3, 'stop_loss_pct': None, 'take_profit_pct': 0.003}
- SOL/USDT: policy=conservative shadow=False notional=40.0 thresholds={'entry_threshold': 0.52, 'exit_threshold': 0.5, 'exit_prob_drop': 0.1, 'min_hold_bars': 3, 'stop_loss_pct': None, 'take_profit_pct': 0.003}
...
algo-data-ingestion/Dockerfile                     |   1 +
 algo-data-ingestion/app/scheduler/main.py          | 120 +++++++++++-
 algo-data-ingestion/app/trading/audit.py           |   3 +
 algo-data-ingestion/app/trading/decision.py        | 102 +++++++++-
 algo-data-ingestion/app/trading/service.py         | 208 ++++++++++++++++++++-
 .../configs/deployment_portfolio_contract.yaml     |   4 +-
 .../dry_run/infer_jobs_portfolio_policy.yaml       |   8 +-
 .../configs/final_trigger_policy.yaml              |  26 +--
 .../runtime_overrides/risk_limits_stage_0.yaml     |   4 +-
 .../configs/runtime_overrides/stage_0.yaml         |   4 +-
 algo-data-ingestion/docker-compose.yml             |   9 +-
 .../models/final_xgb_primary/manifest.json         |   9 +-
 algo-data-ingestion/tests/test_decision_logic.py   |  30 +++
 13 files changed, 483 insertions(+), 45 deletions(-)