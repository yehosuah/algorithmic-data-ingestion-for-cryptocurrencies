...
- **Inference parity** – Mirror the manifest-driven gates inside the FastAPI ingestion/inference path via `training/infer.py::score_base_with_manifest` and keep regression tests that replay historical batches tied to the new Prometheus gauges.
