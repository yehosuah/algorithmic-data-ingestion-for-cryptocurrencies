...
class TradingConfig(BaseSettings):
    ...
    state_postgres_table: str = Field("crypto_app.trading_positions", alias="TRADING_STATE_PG_TABLE")
    ...
    audit_postgres_table: str = Field("crypto_app.trading_audit_events", alias="TRADING_AUDIT_TABLE")
    auto_create_db_tables: bool = Field(False, alias="AUTO_CREATE_DB_TABLES")
